package com.d.candy.f.androidviewtutorial;
...
//        }
    ...
    private void switchFragments(Fragment fragment) {
        if(fragment == null) {
            throw new NullPointerException("in switchFragment(): @fragment is null !");
        }

        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.fragment_container, fragment);
        // Add the transaction to the back stack to the user can navigate back
